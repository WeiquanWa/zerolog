...
[![godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/WeiquanWa/zerolog) [![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/rs/zerolog/master/LICENSE) [![Build Status](https://travis-ci.org/rs/zerolog.svg?branch=master)](https://travis-ci.org/rs/zerolog) [![Coverage](http://gocover.io/_badge/github.com/WeiquanWa/zerolog)](http://gocover.io/github.com/WeiquanWa/zerolog)
...
Find out [who uses zerolog](https://github.com/WeiquanWa/zerolog/wiki/Who-uses-zerolog) and add your company / project to the list.
...
```bash
go get -u github.com/WeiquanWa/zerolog/log
```
...
For simple logging, import the global logger package **github.com/WeiquanWa/zerolog/log**

```go
package main

import (
    "github.com/WeiquanWa/zerolog"
    "github.com/WeiquanWa/zerolog/log"
)
...
Using `github.com/WeiquanWa/errors`, you can add a formatted stacktrace to your errors. 
...
import (
	...
	"github.com/WeiquanWa/zerolog/pkgerrors"
...
The `github.com/WeiquanWa/zerolog/hlog` package provides some helpers to integrate zerolog with `http.Handler`.
